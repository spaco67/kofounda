...
export const TAB_ICONS: Record<TabType, string> = {
  ...
  'kofounda-academy': 'i-ph:graduation-cap-fill',
  'referral': 'i-ph:users-fill',
...
export const DEFAULT_TAB_CONFIG = [
  ...
  { id: 'kofounda-academy', visible: true, window: 'user' as const, order: 2 },
  { id: 'referral', visible: true, window: 'user' as const, order: 3 },
  ...
  { id: 'kofounda-academy', visible: true, window: 'developer' as const, order: 2 },
  { id: 'referral', visible: true, window: 'developer' as const, order: 3 },
